...
export default function CreateEmployee() {
    ...
    const [employee,setEmployee]=useState({fname:"",
    lname:"",email:""})
                          ...
                          <form>
                            <div className="form-group my-2">
                              ...
                              <input placeholder="First Name" name="fname" className="form-control"
                                     value={employee.fname} onChange={handleClick}/>
                                     {<p style={{color:"red",textAlign:"center"}}>{errors.fname}</p>}

                            </div>
                            <div className="form-group my-2">
                              <label>Last Name:</label>
                              <input placeholder="Last Name" name="lname" className="form-control"
                                     value={employee.lname} onChange={handleClick}/>
                                     {<p style={{color:"red",textAlign:"center"}}>{errors.lname}</p>}
